 ...
 *
 * @details Constructs the (complex) Schrodinger semigroup at a given time moment.
 *
 */
template <int D>
 ...
 * @param[in] max_Jpower: maximum amount of power integrals used.
 *
 * @details Adaptively constructs the (complex) Schrodinger semigroup at a given time moment.
...
/** @brief Creates the complex operator (in progress)
 *
